...
namespace SampleWebApiAspNetCore.v1.Controllers
{
    ...
    public class FoodsController : ControllerBase
    {
        ...
        
        {
            ...
            {
                //var rng = new Random();
                //Console.WriteLine("Value of rng is" + rng);
                if (id > 800)
                {
            ...
            {
                Serilog.Log.Error(ex, "Something bad happened - The Food Item ID entered, is out of range");
        ...
        */
        ...
        public ActionResult<FoodDto> AddFood(ApiVersion version, [FromBody] FoodCreateDto foodCreateDto)
        {
            ...
            Serilog.Log.Information($"Food Item entered is {HttpContext.Response.Body}");
